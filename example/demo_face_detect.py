...
video_capture = cv2.VideoCapture('videos/mrplayer.mp4')
...
while True:
    ...
    if len(face_boxes) > 0:
        for i in range(len(face_boxes)):
            ...
            text_x = box[1]
            text_y = box[2] + 10
            cv2.rectangle(frame,(box[1], box[2]+1), (box[1]+30, box[2]+10),  (0, 0, 255),-1);
            cv2.putText(frame, '%2.3f' % face_scores[i], (text_x, text_y), cv2.FONT_HERSHEY_COMPLEX_SMALL,
